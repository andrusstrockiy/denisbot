...
def getdata(bot, update):
    ...
    for call in calls:
        # print(call)
        txt = "Phone:{} Name :{}".format(call['Phone'], call['BussName'])
        reply_markup = InlineKeyboardMarkup(keyboard)
...
def main():
    ...
    updater.dispatcher.add_handler(CommandHandler('getdata', getdata))
